...
import com.rakshit.springjpa.service.EmployeeService;
...
public class Main {
	...
	public static void main(String[] args) {
		...
		ApplicationContext applicationContext = new ClassPathXmlApplicationContext("com/rakshit/springjpa/config/my_spring_config.xml");
